...
class KT_MailChimp_Settings
{
    ...
    public function add_plugin_page()
    {
        ...
        add_options_page(
            __('KT MailChimp Settings', 'cruxstore_core'),
            __('KT MailChimp', 'cruxstore_core'),
            'manage_options',
    ...
    public function create_admin_page()
    {
        ?>
        <div class="wrap">
            <h2><?php _e('Mail Chimp Settings', 'cruxstore_core' ); ?></h2>
    ...
    public function page_init()
    {
        ...
        add_settings_section(
            ...
            __('Settings', 'cruxstore_core'), // Title
        ...
        add_settings_field(
            'api_key', // ID
            __('Mail Chimp API Key', 'cruxstore_core'), // Title
        ...
        if ( isset ( $api_key ) && !empty ( $api_key ) ) {
            add_settings_field(
                'email_lists', // ID
                __('Email Lists', 'cruxstore_core'), // Title
            ...
            add_settings_field(
                'other_option', // ID
                __('Other option', 'cruxstore_core'), // Title
            ...
            add_settings_section(
                ...
                __('Messages', 'cruxstore_core'), // Title
                array( $this, 'print_section_info' ), // Callback
                'mailchimp-settings' // Page
            );
            ...
            add_settings_field(
                ...
                __('Successfully subscribed', 'cruxstore_core'), // Title
    ...
    public function api_key_callback()
    {
        ...
        printf(
            ...
            __('Enter your mail Chimp API key to enable a newsletter signup option with the registration form.', 'cruxstore_core')
        );
    }
    public function email_lists_callback(){
        ...
        if ( isset ( $api_key ) && !empty ( $api_key ) ) {
            ...
            printf(
                '<p class="description">%s</p>',
                __('Place the short code shown below any list in a post or page to display the signup form, or use the dedicated widget.', 'cruxstore_core')
            );
        }
    }
    ...
    public function other_option_callback(){
        ...
        echo '<li><strong>'.__('Double Opt In', 'cruxstore_core').'</strong> : opt_in="yes". ( EX: yes or no)</li>';
        echo '<li><strong>'.__('Disable Names', 'cruxstore_core').'</strong> : disable_names="yes". ( EX: yes or no)</li>';
        echo '<li><strong>'.__('Layout', 'cruxstore_core').'</strong> : layout="1" (EX: 1, 2)</li>';
        echo "</ul>";
    }
    ...
    function messages_successfully_callback(){
        printf(
            ...
            isset( $this->options['messages_successfully'] ) ? esc_attr( $this->options['messages_successfully']) : __('Thank you, your sign-up request was successful! Please check your email inbox to confirm.', 'cruxstore_core')
        );
        printf(
            '<p class="description">%s</p>',
            __('The text that shows when an email address is successfully subscribed to the selected list.', 'cruxstore_core')
        );
    }
