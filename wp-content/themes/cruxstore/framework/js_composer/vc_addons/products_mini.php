...
class WPBakeryShortCode_CruxStore_Products_Mini extends WPBakeryShortCode {
    protected function content($atts, $content = null) {
        ...
        $elementClass = array(
            'base' => apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'cruxstore-products-mini', $this->settings['base'], $atts ),
...
vc_map( array(
    "name" => esc_html__( "KT: Products Mini", 'cruxstore'),
    "base" => "cruxstore_products_mini",
