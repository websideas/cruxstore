...
if ( $rating_count > 0 ) : ?>
    <div class="woocommerce-product-rating" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
        ...
        <span class="star-rating-count">
            <?php printf( _n( '%s review', '%s reviews', $review_count, 'cruxstore' ), '<span itemprop="reviewCount" class="count">' . $review_count . '</span>' ); ?>
        </span>
        <?php if ( comments_open() ) : ?>
            <a href="#reviews" class="woocommerce-review-link" rel="nofollow"><?php esc_html_e('Leave a review', 'cruxstore') ?></a>
        <?php endif ?>
    </div>
<?php endif; ?>
