...
<table class="shop_table shop_table_responsive cart" cellspacing="0">
	<thead>
		<tr>
			...
			<th class="product-thumbnail"><?php esc_html_e( 'Item', 'cruxstore' ); ?></th>
			<th class="product-name"><?php esc_html_e( 'Product', 'woocommerce' ); ?></th>
            <th class="product-quantity"><?php esc_html_e( 'Quantity', 'woocommerce' ); ?></th>
			<th class="product-price"><?php esc_html_e( 'Unit Price', 'cruxstore' ); ?></th>
...
<div class="cart-collaterals row">
    ...
    <div class="wc-coupon-wrap col-md-4 col-sm-6 col-xs-12">
        <form method="post" class="wc-cart-box" action="<?php echo esc_url( WC()->cart->get_cart_url() ); ?>">
            <h5 class="wc-cart-box-heading"><?php esc_html_e('Promotional Code', 'cruxstore'); ?></h5>
