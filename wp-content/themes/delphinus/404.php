...
$type = delphinus_option('notfound_page_type', 'default');
/* Redirect Home */
if( $type == 'home'){
...
<div class="wrapper-404">
    <div id="error404">
        ...
        <p class="no-margin"><a href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php esc_html_e('Return home', 'delphinus') ?> <i class="delphinus-icon-Right-3"></i></a></p>
