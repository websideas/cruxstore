    ...
    <div class="container">
        <div class="up-sells-wrapper">
            <div class="delphinus-heading text-center">
                ...
                <h3 class="delphinus-heading-title"><?php esc_html_e( 'You may also like', 'delphinus' ) ?></h3>
            </div>
            <div class="owl-carousel-kt navigation-center-outside  navigation-normal">
                <div class="wc-carousel-wrapper" data-options='<?php echo esc_attr(apply_filters('delphinus_wc_product_carousel', '{"desktop": "4","desktopsmall": "3","tablet": "2","mobile": "1","navigation": true, "pagination": false}')) ?>'>
