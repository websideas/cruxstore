...
<?php
    ...
    $items = apply_filters('delphinus_product_thumbnail_items-quickview', 3, $layout);
    $items_mb = apply_filters('delphinus_product_thumbnail_items_mobile-quickview', 3, $layout);
