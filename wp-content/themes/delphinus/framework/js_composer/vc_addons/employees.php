    ...
    protected function content($atts, $content = null) {
        ...
        if ( $query->have_posts() ) :
            ...
            while ( $query->have_posts() ) : $query->the_post();
                ...
                $image = get_the_post_thumbnail(get_the_ID(), 'delphinus_square');
                if(!$image){
...
vc_map( array(
    ...
    "params" => array(
        ...
        array(
            ...
            "edit_field_class" => "delphinus_sub_heading vc_column",
        ...
        array(
            "type" => "delphinus_posts",
            'args' => array('post_type' => 'del_employees', 'posts_per_page' => -1),
