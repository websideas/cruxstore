...
class WPBakeryShortCode_Delphinus_Products_Mini extends WPBakeryShortCode {
    protected function content($atts, $content = null) {
        ...
        $elementClass = array(
            'base' => apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'delphinus-products-mini', $this->settings['base'], $atts ),
