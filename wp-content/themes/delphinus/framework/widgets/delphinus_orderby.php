...
class WC_Widget_DELPHINUS_Orderby extends WC_Widget {

    /**
     * Constructor.
     */
    public function __construct() {
        $this->widget_cssclass    = 'woocommerce widget_delphinus_orderby';
        $this->widget_description = esc_html__( 'Display a product sorting list.', 'delphinus' );
        $this->widget_id          = 'wc_delphinus_orderby';
        $this->widget_name        = esc_html__( 'KT: WooCommerce Product Sorting', 'delphinus' );
        $this->settings           = array(
            'title'  => array(
                'type'  => 'text',
                'std'   => esc_html__( 'Sort By', 'delphinus' ),
...
register_widget('WC_Widget_DELPHINUS_Orderby');
