 ...
 * @extends  WC_Widget
 */
class WC_Widget_Delphinus_Price_Filter extends WC_Widget {

    /**
     * Constructor.
     */
    public function __construct() {
        $this->widget_cssclass    = 'woocommerce widget_delphinus_price_filter';
        ...
        $this->widget_id          = 'wc_delphinus_price_filter';
        ...
        $this->settings           = array(
            ...
            'range_size' => array(
                ...
                'step'  => 1,
                'std'   => 50,
                'label' => esc_html__( 'Price range size', 'delphinus' )
            ),
            'max_ranges' => array(
                'type'  => 'number',
                'min'   => 1,
                ...
                'step'  => 1,
                'std'   => 5,
                'label' => esc_html__( 'Max price ranges', 'delphinus' )
            )
        );
...
register_widget('WC_Widget_Delphinus_Price_Filter');
