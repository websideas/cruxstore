...
/**
 * DELPHINUS_Posts widget class
 *
 * @since 1.0
 */
class Widget_Delphinus_Posts_Carousel extends WP_Widget {

    public function __construct() {
        $widget_ops = array('classname' => 'widget_delphinus_posts_carousel', 'description' => esc_html__( "Show posts of categories.",'delphinus') );
        parent::__construct('delphinus_posts_carousel', esc_html__('KT: Posts Carousel', 'delphinus'), $widget_ops);
        $this->alt_option_name = 'widget_delphinus_posts_carousel';
    ...
    public function widget($args, $instance) {
        ...
        if ($r->have_posts()) :
            ...
            <?php while ( $r->have_posts() ) : $r->the_post(); ?>
                <div <?php post_class(); ?>>
                    <?php delphinus_post_thumbnail_image( 'delphinus_square', 'img-responsive', false ); ?>
    ...
    public function form( $instance ) {
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id( 'number' )); ?>"><?php esc_html_e( 'Number of posts to show:','delphinus' ); ?></label>
        ...
        <div><label for="<?php echo esc_attr($this->get_field_id('category')); ?>"><?php esc_html_e('Categories:','delphinus'); ?> </label>
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('orderby')); ?>"><?php esc_html_e('Order by:', 'delphinus'); ?></label>
        ...
        <p><label for="<?php echo esc_attr($this->get_field_id('order')); ?>"><?php esc_html_e('Order:','delphinus'); ?></label>
...
/**
 * Register Delphinus_Posts_Carousel widget
 *
 *
 */

register_widget('Widget_Delphinus_Posts_Carousel');