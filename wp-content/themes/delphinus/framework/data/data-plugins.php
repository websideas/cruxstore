...
add_action( 'tgmpa_register', 'delphinus_register_plugins' );
/**
 ...
 */
function delphinus_register_plugins() {
    /**
    ...
    $plugins = array(
        array(
            'name'          => 'Delphinus Core', // The plugin name
            'slug'          => 'delphinus_core', // The plugin slug (typically the folder name)
            'source'            => 'http://kitethemes.com/plugins/delphinus_core.zip', // The plugin source
